...
BEGIN
   ...
   DELETE FROM TIMETMP.TMP_INT512 WHERE SKEY = NS_INSASEGURADOSTODOS512.SKEY;
   IF SQL%ROWCOUNT = 0 THEN
      DELETE FROM TIMETMP.TMP_INT512;
   END IF;
   ...
   COMMIT;
    ...
    INSERT INTO TMP_INT512 (
        ...
        AND vpol.codestadopoliza NOT IN (2,3,7,8) -- SE QUITAN LAS POLIZAS QUE NO ESTAN ACTIVAS

                    ...
                    -------------------------------------------------------------------------------------
                       ...
                       WHERE VPOL.codFrecuenciaPago <> 8 -- CON FINANCIAMIENTO   
                        ...
                        AND NVL(VPol.CodIntermediario,0) = CASE WHEN NS_INSCONTROLINGRESO511.NINTERMED=0 
                                                                 OR NS_INSCONTROLINGRESO511.NINTERMED IS NULL
                                                            THEN NVL(VPol.CodIntermediario,0)  ELSE NS_INSCONTROLINGRESO511.NINTERMED END 			
--                       AND NVL(UsrCaja.NUSERCODE,0) = CASE WHEN  NVL(NS_INSCONTROLINGRESO511.NCAJERO,0) = 0
--                                                                OR NS_INSCONTROLINGRESO511.NCAJERO IS NULL 
--                                                        THEN NVL(UsrCaja.NUSERCODE,0) ELSE NS_INSCONTROLINGRESO511.NCAJERO END
